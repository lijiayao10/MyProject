...
public class PiActor {
    ...
    public static class Master extends UntypedActor {
        ...
        public Master(final int nrOfWorkers, int nrOfMessages, int nrOfElements, ActorRef listener) {
            ...
            workerRouter = this.getContext()
                    .actorOf(Props.create(Worker.class).withRouter(new RoundRobinRouter(nrOfWorkers)), "workerRouter");
        }
    ...
    public void calculate(final int nrOfWorkers, final int nrOfElements, final int nrOfMessages) {
        ...
        //        master.tell(new Master(nrOfWorkers, nrOfMessages, nrOfElements, listener),);
