package com.cjy.code.laoa.chapter04.socket;
...
import com.cjy.code.laoa.chapter04.socket.client.component.CharsetByteRelative;
import com.cjy.code.laoa.chapter04.socket.client.sender.BFileSender;
import com.cjy.code.laoa.chapter04.socket.client.sender.DefaultSender;
import com.cjy.code.laoa.chapter04.socket.client.sender.FileSender;
import com.cjy.code.laoa.chapter04.socket.client.sender.GetFileSender;
import com.cjy.code.laoa.chapter04.socket.client.sender.MessageSender;
import com.cjy.code.laoa.chapter04.socket.client.sender.Sendable;
...
public class Commons {
    ...
    private final static SimpleDateFormat                       DATE_FORMAT_OBJECT      = new SimpleDateFormat(
    ...
    private final static List<CharsetByteRelative>              CHASET_BYTE_LIST        = Arrays
            .asList(new CharsetByteRelative("utf8", (byte) 1),
                    new CharsetByteRelative("gbk", (byte) 2),
                    new CharsetByteRelative("utf16", (byte) 3));

    private final static Map<String, Class<? extends Sendable>> ORDER_CLASS_MAP         = new HashMap<String, Class<? extends Sendable>>() {
                                                                                            private static final long serialVersionUID = 3431099761909680054L;

                                                                                            {
                                                                                                put(SEND_MESSAGE_STR
                                                                                                        .toLowerCase(),
                                                                                                        MessageSender.class);
                                                                                                put(SEND_FILE_STR
                                                                                                        .toLowerCase(),
