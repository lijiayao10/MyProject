...
public class RSATest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //        byte[] keyBytes = Base64.decodeBase64("1234567890qwertyuiopasdfghjklzxc");
        //        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec("1234567890qwertyuiopasdfghjklzxc".getBytes());
        //        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
        //        Key publicK = keyFactory.generatePublic(x509KeySpec);
        //
        //        Map<String, Object> keyMap = new HashMap<>();
        //        keyMap.put("RSAPublicKey", publicK);
        //
        //        System.out.println("publicRSA:" + RSA.getPublicKey(keyMap));
        System.out.println("公钥:" + Base64.encodeBase64String("1234567890qwertyuiopasdfghjklzxc".getBytes()));
