...
public class ThreadMain {
    public static void main(String[] args) {
        ...
        System.out
                .println("I am main thread, after others is ok. time is " + (System.currentTimeMillis() - currentTime));
    }
}
...
class MayTask implements Runnable {
    ...
    public void run() {
        try {
            System.out
                    .println("Current thread name is" + Thread.currentThread().getName() + "i will sleep " + sleepTime);
